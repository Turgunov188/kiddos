              ...
              <div class="box box-primary">
                 <div class="box-body">
                    ...
                    <div class="table-responsive">
                    	<?php if(session('teacher-updated')): ?>
                          <?php $__env->startComponent('back.components.alert'); ?>
                              <?php $__env->slot('type'); ?>
                                  success
                              <?php $__env->endSlot(); ?>
                              <?php echo session('teacher-updated'); ?>
...
<?php echo $__env->make('back.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\OpenServer\domains\laravel-compare\resources\views/back/index.blade.php ENDPATH**/ ?>